...
const StyledWrapper = styled.div`
  ...
  .coffee-header {
    ...
    top: 0;
    left: 0;
    background-color: #eae9e5;  /* cararra - light background */
    border-radius: 10px;
  }
  ...
  .coffee-header__buttons {
    ...
    position: absolute;
    top: 25px;
    background-color: #2f330b;  /* waiouru - dark green */
    border-radius: 50%;
  }
  ...
  .coffee-header__details {
    ...
    top: 10px;
    right: 10px;
    background-color: #cfbda3;  /* vanilla - beige color */
    box-shadow: -12px 0 0 #cfbda3, -24px 0 0 #cfbda3;  /* vanilla */
  }
  ...
  .coffee-medium:before {
    ...
    width: 90%;
    height: 100px;
    background-color: #78875e;  /* flax-smoke - matcha green */
    position: absolute;
    bottom: 0;
    left: calc(50% - 45%);

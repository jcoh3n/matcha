  ...
  return (
    <div className="w-full min-h-screen font-poppins">
      ...
      <div className="hidden lg:flex w-full min-h-[90vh] relative ">
        ...
        <div className="w-3/5 flex flex-col p-8 items-center justify-center ">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="px-2 flex flex-row items-center gap-6">
                      ...
                      <span className="text-xl font-semibold underline ml-2">
                        100%
                      </span>
                    </div>
                  </div>
                    ...
                    <label className="text-2xl font-semibold text-gray-700 flex items-center gap-2 mb-3">
                      ...
                      {filters.tags.length > 0 && (
                        <span className="text-xs font-medium text-white bg-[#7FB77E] px-2 py-0.5 rounded-full">
                          {filters.tags.length} sélectionné
                ...
                <div className="rounded-xl overflow-hidden shadow-soft bg-white flex flex-col lg:flex-row transition-all duration-300">
                  ...
                  <div className="w-full  flex flex-col p-6 lg:p-8 gap-4 bg-[#9ed09d]">
                    <div className="flex flex-col space-y-3 items-start  py-40">
                      ...
                      <span className="inline-flex items-center px-3 py-1 rounded-full bg-white/20 text-black/80 text-sm font-semibold mt-2">
                        {Math.round(currentProfile.fameRating ?? 0)}{" "}
                      </span>
            ...
            <div className="rounded-xl overflow-hidden shadow-soft bg-white flex flex-col transition-all duration-300">
              <div className="relative w-full h-[420px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <div className="mt-2">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-white/25 text-white text-xs font-semibold">
                      {Math.round(currentProfile.fameRating ?? 0)}
                    </span>
                  </div>
                  {currentProfile.tags?.length ? (
                    <div className="mt-2 flex flex-wrap gap-1">
                      {currentProfile.tags.slice(0, 3).map((t: string) => (
                        <span
                          key={t}
                          className="px-2 py-0.5 rounded-full bg-white/20 text-white text-[11px]"
                        >
                          {t}
                        </span>
                      ))}

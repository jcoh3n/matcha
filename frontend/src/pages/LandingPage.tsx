...
export function LandingPage({ onAuth }: LandingPageProps) {
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Central CTA */}
      <div className="relative z-20 flex flex-col items-center justify-center text-center px-6 pt-40 md:pt-80">
      ...
      <div className="absolute bottom-4 left-0 right-0 z-20 flex justify-center">
        <p className="text-[10px] md:text-xs text-white/60 font-montserrat px-6 text-center">
